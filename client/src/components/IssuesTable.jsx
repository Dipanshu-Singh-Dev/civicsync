...
function IssuesTable({
  ...
  const goToPage = (page) => {
    if (page >= 1 && page <= totalPages) {
      setCurrentPage(page);
      setSelectedImages([]); // Reset selected images when changing pages
    }
  };
                          ...
                          <Dialog>
                            <DialogTrigger asChild>
                              <Button
                                ...
                                onClick={() =>
                                  setSelectedImages(issue.imageUrls)
                                }
                              >
          ...
          <div className="md:hidden space-y-4 mb-4">
            {currentIssues.length < 1 ? (
              ...
              currentIssues.map((issue) => (
                <div
                  key={issue.id}
                  className="bg-white p-4 rounded-lg border shadow-sm overflow-clip"
                >
